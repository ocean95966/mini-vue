...
function exposeStateOnRenderContext(instance) {
    var proxy = instance.proxy, setupState = instance.setupState;
    if (setupState) {
        Object.keys(setupState).forEach(function (key) {
            Object.defineProperty(proxy, key, {
                enumerable: true,
                configurable: true,
                get: function () { return instance.setupState[key]; },
                set: function () { return undefined; }
            });
        });
    }
...
function setupStatefulComponent(instance) {
    ...
    var setupResult = setup ? setup.apply(void 0, [instance.props, setupContext]) : {};
    if (setup) {
